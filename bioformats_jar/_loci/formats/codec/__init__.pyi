...
class Codec:
    ...
    @typing.overload
    def decompress(self, randomAccessInputStream: bioformats_jar._loci.common.RandomAccessInputStream, codecOptions: 'CodecOptions') -> typing.List[int]: ...
...
class CompressionType(java.lang.Enum['CompressionType'], bioformats_jar._loci.common.enumeration.CodedEnum):
...
class JPEG2000BoxType(java.lang.Enum['JPEG2000BoxType'], bioformats_jar._loci.common.enumeration.CodedEnum):
...
class JPEG2000SegmentMarker(java.lang.Enum['JPEG2000SegmentMarker'], bioformats_jar._loci.common.enumeration.CodedEnum):
...
class JPEGTileDecoder(java.lang.AutoCloseable):
    ...
    @typing.overload
    def initialize(self, randomAccessInputStream: bioformats_jar._loci.common.RandomAccessInputStream, int: int) -> None: ...
    @typing.overload
    def initialize(self, randomAccessInputStream: bioformats_jar._loci.common.RandomAccessInputStream, int: int, int2: int, int3: int) -> None: ...
    def preprocess(self, randomAccessInputStream: bioformats_jar._loci.common.RandomAccessInputStream) -> typing.List[int]: ...
...
class NikonCodecOptions(CodecOptions):
    curve: typing.List[int] = ...
    vPredictor: typing.List[int] = ...
    split: int = ...
    def __init__(self): ...
...
class HuffmanCodec(loci.formats.codec.WrappedCodec):
    def __init__(self): ...
    @typing.overload
    def getSample(self, randomAccessInputStream: bioformats_jar._loci.common.RandomAccessInputStream, codecOptions: CodecOptions) -> int: ...
    @typing.overload
...
class LuraWaveCodec(loci.formats.codec.WrappedCodec):
    def __init__(self): ...
...
class __module_protocol__(typing.Protocol):
    ...
    JPEGXRCodec: typing.Type[JPEGXRCodec]
    ...
    NikonCodec: typing.Type[NikonCodec]
    NikonCodecOptions: typing.Type[NikonCodecOptions]
    ...
    TargaRLECodec: typing.Type[TargaRLECodec]
    WrappedCodec: typing.Type[WrappedCodec]
