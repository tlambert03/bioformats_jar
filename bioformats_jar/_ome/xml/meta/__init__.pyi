...
class MetadataRetrieve(BaseMetadata):
    ...
    def getGenericExcitationSourceMap(self, int: int, int2: int) -> java.util.List[ome.xml.model.MapPair]: ...
    ...
    def getImagingEnvironmentMap(self, int: int) -> java.util.List[ome.xml.model.MapPair]: ...
    ...
    def getMapAnnotationValue(self, int: int) -> java.util.List[ome.xml.model.MapPair]: ...
...
class MetadataStore(BaseMetadata):
    ...
    def setGenericExcitationSourceMap(self, list: java.util.List[ome.xml.model.MapPair], int: int, int2: int) -> None: ...
    ...
    def setImagingEnvironmentMap(self, list: java.util.List[ome.xml.model.MapPair], int: int) -> None: ...
    ...
    def setMapAnnotationValue(self, list: java.util.List[ome.xml.model.MapPair], int: int) -> None: ...
